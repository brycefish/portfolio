...
const ProjectsSection = () => {
    return (
        <section id="projects">
            <h1 className="text-4xl my-10 text-center font-bold text-slate-50">Projects
      ...
      <div className="flex flex-col space-y-28">
        {projects.map((project, idx) => {
          return (
            <div key={idx}>
                <div className="md:flex text-slate-50">
                  ...
                  <div className="mt-8 md:w-1/2">
                    ...
                    <p className="text-xl leading-7 mb-4 text-neutral-100">
                      {project.description}
                    </p>
                    <div className="flex flex-row align-bottom space-x-4 text-teal-400">
